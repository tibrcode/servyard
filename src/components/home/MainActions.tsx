        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="animate-luxury-scale">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 max-w-4xl mx-auto">
              ...
              >
                <Search style={{ width: '48px', height: '48px' }} className="mb-2 text-blue-500" />
              ...
              <Button
                ...
                className="glass-card aspect-square font-medium border border-white/10 hover:border-white/20 transition-all duration-300 rounded-2xl flex flex-col items-center justify-center p-6 md:p-8"
              >
                <Map style={{ width: '48px', height: '48px' }} className="mb-2 text-orange-500" />
              ...
              <Button
                ...
                className="glass-card aspect-square font-medium border border-white/10 hover:border-white/20 transition-all duration-300 rounded-2xl flex flex-col items-center justify-center p-6 md:p-8"
              >
                <LogIn style={{ width: '48px', height: '48px' }} className="mb-2 text-purple-500" />
              ...
              >
                <LayoutDashboard style={{ width: '48px', height: '48px' }} className="mb-2 text-yellow-500" />
