...
exports.pruneOldRequestTraces = exports.monitorDuplicateCategories = exports.snapshotSystemStats = exports.sendScheduledReminders = exports.notifyBookingStatusChange = exports.notifyBookingUpdate = exports.notifyNewBooking = exports.getLocationStats = exports.findNearbyProviders = exports.sendTestNotification = exports.adminBlockUser = exports.adminDeleteUser = exports.onAuthDeleteUser = exports.dedupeServiceCategories = void 0;
...
exports.adminBlockUser = (0, https_1.onRequest)({ maxInstances: 1, secrets: [ADMIN_DELETE_TOKEN] }, async (req, res) => {
    ...
    if (req.method !== 'POST')
        return errorResponse(res, 405, 'method_not_allowed', 'POST required');
    const trace = req.get('x-trace-id');
    // AuthN
    const bearer = (req.get('Authorization') || '').replace(/^Bearer\s+/i, '').trim();
    const headerKey = (req.get('x-admin-key') || req.query.key);
